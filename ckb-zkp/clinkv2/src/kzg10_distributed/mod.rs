...
pub use kzg10::KZG10;
pub use prover::{create_random_proof, gen_witness_polys};
pub use verifier::verify_proof;
pub type VerifyKey<E> = kzg10::VerifierKey<E>;
pub type ProveKey<'a, E> = kzg10::Powers<'a, E>;
pub use self::kzg10::UniversalParams;
...
pub struct Proof<E: PairingEngine> {
    pub q_comm: Kzg10Comm<E>, // 1G
    pub q_r_value: E::Fr, // 1F
    pub q_r_proof: Kzg10Proof<E>, // 1G + 1F
}
